...
public class MFItems {
    ...
    // Rice Items
    public static final RegistrySupplier<Item> RICE = ITEMS.register("rice", () -> new BlockItem(MFBlocks.RICE_CROP.get(), registerItemProperties("rice").useItemDescriptionPrefix()));
