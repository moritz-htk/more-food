...
public class MFBlocks {
    ...
    public static final RegistrySupplier<MFRiceCropBlock> RICE_CROP = BLOCKS.register("rice_crop", () -> new MFRiceCropBlock(BlockBehaviour.Properties.of().setId(registerBlockId("rice_crop"))));
